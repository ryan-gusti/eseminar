        ...
        <div class="card-body">
            ...
            @elseif (session()->has('loginError'))
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h4 class="alert-heading d-flex align-items-center">Login Gagal!</h4>
            ...
            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" id="login-email" name="email" placeholder="budi@contoh.com"
