...
@section('content')
    ...
    <div class="card mb-0">
        <div class="card-body">
            ...
            <p class="card-text mb-2">Input email kamu, kami akan mengirimkan email instruksi reset password</p>
            ...
            <form class="auth-forgot-password-form mt-2" action="{{ route('password.email') }}" method="POST">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" id="forgot-password-email" name="email"
                        placeholder="contoh@example.com" aria-describedby="forgot-password-email" tabindex="1" autofocus />
                </div>
                <button class="btn btn-primary w-100" tabindex="2">Kirim Instruksi</button>
            </form>
