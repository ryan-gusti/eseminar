...
@section('content')
    ...
    <div class="card mb-0">
        <div class="card-body">
            ...
            <p class="card-text mb-2">Silahkan input password baru anda</p>

            {{-- Validasi Error --}}
            @if ($errors->any())
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h4 class="alert-heading d-flex align-items-center">Ubah Gagal!</h4>
            ...
            <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}" method="POST">
                ...
                <div class="mb-1">
                    <label for="reset-pass-email" class="form-label">Email</label>
                    <input type="text" class="form-control" id="reset-pass-email" name="email"
                        value="{{ old('email', $request->email) }}" aria-describedby="reset-pass-email" readonly />
                </div>
                <div class="mb-1">
                ...
                <button class="btn btn-primary w-100" tabindex="3">Ubah Password</button>
            </form>
