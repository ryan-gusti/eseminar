            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Kelola Informasi</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">List Informasi</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function(e, dt, button, config) {
                        window.location = '{{ route('admin.announcements.create') }}';
                    }
                }
            ],
            responsive: {
        ...
        $('div.head-label').html('<h6 class="mb-0">List Informasi</h6>');
    </script>
@endsection
