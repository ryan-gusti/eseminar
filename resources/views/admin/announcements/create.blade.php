...
@section('title', 'Buat Informasi Baru')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Buat Informasi Baru</h2>
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select data-placeholder="Pilih Role.." class="select2-icons form-select"
                                                ...
                                                <optgroup label="Pilih Role">
                                                    <option value="partner" data-icon="user-check">PARTNER
                                                    </option>
                                                    <option value="user" data-icon="user">USER</option>
                                                </optgroup>
                                            </select>
                                            @error('type')
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
