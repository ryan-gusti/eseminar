            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Tambah Sertifikat Baru</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">List Informasi</a>
                                    </li>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.certificates.store') }}" method="POST" 
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" value="{{ old('code', Str::random(10)) }}" name="code"/>
                                        <div class="col-12 mb-2">
                                            <div class="border rounded p-2">
                                                <h6 class="mb-1"><i data-feather='image'></i> Gambar Master Sertifikat</h6>
                                                <div class="d-flex flex-column flex-md-row">
                                                    <a id="cert-preview-image" data-fancybox="banner-preview" data-src="{{ asset('storage/certificate-event/sign.png') }}"><img src="{{ asset('storage/certificate-event/sign.png') }}" id="cert-feature-image" class="rounded me-2 mb-1 mb-md-0" width="170" height="110" alt="Blog Featured Image" /></a>
                                                    <div class="featured-info">
                                                        ...
                                                        <div class="d-inline-block">
                                                            <input class="form-control" type="file" id="certCustomFile" accept="image/*" name="file_certificate" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input class="form-control" type="file" id="font_master" accept=".ttf" name="file_font[]">
                                        </div>
                                        <div class="col-md-6 mb-1">
                                            <label class="form-label" for="type">Font Nama</label>
                                            <input class="form-control" type="file" id="font_name" accept=".ttf" name="file_font[]">
                                        </div>
                                        <div class="col-md-4 mb-1">
                                            <label class="form-label" for="name_colour">Warna Nomor & Nama</label>
                                            <input class="form-control" type="color" id="name_colour" name="font_colour[number_name]">
                                        </div>
                                        <div class="col-md-4 mb-1">
                                            <label class="form-label" for="name_colour">Warna Judul & Tanggal</label>
                                            <input class="form-control" type="color" id="title_time" name="font_colour[title_time]">
                                        </div>
                                        <div class="col-md-4 mb-1">
                                            <label class="form-label" for="name_colour">Warna Ketua & Pemateri</label>
                                            <input class="form-control" type="color" id="ketua_pemateri" name="font_colour[ketua_pemateri]">
                                        </div>
                                    </div>
                            </div>
