                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            ...
                            <!-- form -->
                            <form action="{{ route('user.profile.update') }}" method="POST" class="validate-form mt-2 pt-50">
                            @method("PUT")
                            @csrf
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="name">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', auth()->user()->name) }}" data-msg="Please enter first name" />
                                        @error('name')
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="08xxxxx" value="{{ old('phone', auth()->user()->phone) }}" data-msg="Please enter last name" />
                                        @error('phone')
                                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                            <div class="alert-body d-flex align-items-center">
                                              <i data-feather="info" class="me-50"></i>
